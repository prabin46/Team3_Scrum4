...
<LI><A HREF="Input.jsp?method=13&methodName=createPiano" TARGET="inputs">createPiano(java.lang.String,int,double)</A></LI>
</UL>
<%
if (com.ibm.ccl.ws.jaxws.gstc.util.AsyncUtils.hasAsync(sampleTeam3_Piano_APIPortProxyid.getClass())) {
%>
